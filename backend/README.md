...
## Project Structure
    ...
    ├── testapiautocatalog_103599  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_103599`
...
2. Clone this repo and `cd testapiautocatalog_103599`
